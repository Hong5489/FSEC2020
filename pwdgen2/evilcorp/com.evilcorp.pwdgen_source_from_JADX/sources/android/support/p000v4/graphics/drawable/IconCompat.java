...
public class IconCompat {
    ...
    public void addToShortcutIntent(Intent intent) {
        int i = this.mType;
        String str = "android.intent.extra.shortcut.ICON";
        if (i == 1) {
            intent.putExtra(str, (Bitmap) this.mObj1);
        } else if (i == 2) {
            ...
            intent.putExtra(str, createLegacyIconFromAdaptiveIcon((Bitmap) this.mObj1));
        } else {
