...
public class FontResourcesParserCompat {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        int i = obtainAttributes.getInt(obtainAttributes.hasValue(C0003R.styleable.FontFamilyFont_fontWeight) ? C0003R.styleable.FontFamilyFont_fontWeight : C0003R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
        boolean z = true;
