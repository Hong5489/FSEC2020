...
import android.support.p003v7.recyclerview.C0323R;
...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    /* renamed from: UP */
    public static final int f21UP = 1;
    int mActionState = 0;
            ...
            if (actionMasked == 0) {
                ...
                if (ItemTouchHelper.this.mSelected == null) {
                    ...
                    if (findAnimation != null) {
                        ItemTouchHelper.this.mInitialTouchX -= findAnimation.f22mX;
                        ItemTouchHelper.this.mInitialTouchY -= findAnimation.f23mY;
    ...
    public static abstract class Callback {
        ...
        public void onDraw(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                onChildDraw(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f22mX, recoverAnimation.f23mY, recoverAnimation.mActionState, false);
        ...
        public void onDrawOver(Canvas canvas, RecyclerView recyclerView, ViewHolder viewHolder, List<RecoverAnimation> list, int i, float f, float f2) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                int save = canvas.save();
                onChildDrawOver(canvas, recyclerView, recoverAnimation.mViewHolder, recoverAnimation.f22mX, recoverAnimation.f23mY, recoverAnimation.mActionState, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas.save();
    ...
    private static class RecoverAnimation implements AnimatorListener {
        ...
        public void update() {
            ...
            if (f == f2) {
                this.f22mX = this.mViewHolder.itemView.getTranslationX();
            } else {
                this.f22mX = f + (this.mFraction * (f2 - f));
            }
            float f3 = this.mStartDy;
            float f4 = this.mTargetY;
            if (f3 == f4) {
                this.f23mY = this.mViewHolder.itemView.getTranslationY();
            } else {
                this.f23mY = f3 + (this.mFraction * (f4 - f3));
            }
        }
    ...
    public View findChildView(MotionEvent motionEvent) {
        ...
        for (int size = this.mRecoverAnimations.size() - 1; size >= 0; size--) {
            ...
            if (hitTest(view2, x, y, recoverAnimation.f22mX, recoverAnimation.f23mY)) {
                return view2;
            }
        }
