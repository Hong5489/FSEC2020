...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0320R.styleable.ButtonBarLayout);
        this.mAllowStacking = obtainStyledAttributes.getBoolean(C0320R.styleable.ButtonBarLayout_allowStacking, z);
    ...
    private void setStacked(boolean z) {
        ...
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0320R.C0322id.spacer);
