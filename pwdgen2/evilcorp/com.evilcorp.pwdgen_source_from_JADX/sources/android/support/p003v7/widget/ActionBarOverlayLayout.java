...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0320R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0320R.C0322id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0320R.C0322id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0320R.C0322id.action_bar));
        }
    }
