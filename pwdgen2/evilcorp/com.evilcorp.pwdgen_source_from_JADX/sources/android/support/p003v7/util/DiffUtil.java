    ...
    public static class DiffResult {
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f16x + snake.size;
                int i4 = snake.f17y + snake.size;
                ...
                for (int i5 = 0; i5 < snake.size; i5++) {
                    int i6 = snake.f16x + i5;
                    int i7 = snake.f17y + i5;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f16x + snake.size;
                int i7 = snake.f17y + snake.size;
                int i8 = 8;
                if (z) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f16x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f16x + i6, 1, this.mCallback.getChangePayload(snake.f16x + i6, snake.f17y + i6));
                    }
                }
                i = snake.f16x;
                i2 = snake.f17y;
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f16x + diffPartial.size;
                    range.newListStart = diffPartial.f17y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = diffPartial.f16x + diffPartial.size + 1;
                    range.newListStart = diffPartial.f17y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f16x + diffPartial.size;
                    range.newListStart = diffPartial.f17y + diffPartial.size + 1;
                }
