...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int i, View view, LayoutParams layoutParams) {
        ...
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C0019R.C0021id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C0019R.C0021id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0019R.C0021id.touch_outside).setOnClickListener(new OnClickListener() {
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0019R.attr.bottomSheetDialogTheme, typedValue, true)) {
