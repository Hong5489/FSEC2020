...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(View view, CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(findSuitableParent.getContext()).inflate(C0019R.layout.design_layout_snackbar_include, findSuitableParent, false);
    ...
    public Snackbar setCallback(Callback callback) {
        BaseCallback<Snackbar> baseCallback = this.mCallback;
