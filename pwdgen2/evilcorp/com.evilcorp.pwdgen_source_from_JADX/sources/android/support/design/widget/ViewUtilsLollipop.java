...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float f) {
        ...
        long j = (long) integer;
        stateListAnimator.addState(new int[]{16842766, C0019R.attr.state_collapsible, -C0019R.attr.state_collapsed}, ObjectAnimator.ofFloat(view, str, new float[]{0.0f}).setDuration(j));
