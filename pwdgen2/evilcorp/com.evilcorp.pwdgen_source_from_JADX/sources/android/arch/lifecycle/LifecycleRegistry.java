...
public class LifecycleRegistry extends Lifecycle {
    ...
    static /* synthetic */ class C00021 {
        ...
        static {
            ...
            L_0x0091:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.arch.lifecycle.LifecycleRegistry.C00021.<clinit>():void");
        }
    }
    ...
    private static Event downEvent(State state) {
        int i = C00021.$SwitchMap$android$arch$lifecycle$Lifecycle$State[state.ordinal()];
        if (i == 1) {
